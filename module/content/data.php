          ...
          <div class="col-lg-12">
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td>2021</td>
					<td>
					  <a href="desa.php?page=data&aksi=detail" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i> Detail</a>
					</td>
				</tr>
			...
			<div class="col-md-4">
              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                 ...
                 <li class="list-group-item">
                    <b>Foto KTP</b> <a href="#" class="float-right"><i class="fa fa-file"></i> Unduh</a>
				 </li>
                 <li class="list-group-item">
                    <b>Foto KK</b> <a href="#" class="float-right"><i class="fa fa-file"></i> Unduh</a>
				 </li>
                </ul>
